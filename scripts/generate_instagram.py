...
# ─────────────────────────────────────────────────────────────────────
# キャプション冒頭（自己分析フレーミング・季節導入）
# ─────────────────────────────────────────────────────────────────────
CAPTION_INTRO_TABLE = {
(1,"early"): "1月に入ったばかりのこの時期は、新しい一年への期待と同時に、去年からの課題や迷いも心のどこかに残りやすいものです。頭では切り替えたつもりでも、気持ちの整理が追いついていないこともあります。",
(1,"mid"):   "お正月気分が落ち着いてくるこの時期は、日常のペースが戻ってくる一方で、今年の方向性をまだ決めきれていない人も多いはずです。周りが動き出す中で、自分だけ足踏みしているように感じることもあります。",
(1,"late"):  "1月も終わりに近づくこの時期は、年始に立てた計画と現実のズレに気づき始める頃でもあります。焦って結論を出す前に、一度立ち止まりたくなる方も多いのではないでしょうか。",

(2,"early"): "2月に入り、寒さの厳しさが続くこの時期は、外に出る機会が減る分、自分の内側と向き合う時間が増えやすいものです。考えごとが増えるわりに、答えが出ないまま日が過ぎることもあります。",
(2,"mid"):   "2月半ばのこの時期は、年度替わりを意識し始める人も多く、今のままでいいのか気になり始める頃です。忙しさに紛れて、本音を後回しにしてしまうこともあるはずです。",
(2,"late"):  "2月も終わりに近づくこの時期は、年度末を前に、身の回りの整理や決断を迫られる場面が増えてくる頃です。時間に追われる中で、本当はどうしたいのか見えにくくなることもあります。",

(3,"early"): "3月に入り、年度末が近づくこの時期は、これまでの一年を振り返りたくなる一方で、区切りをつけきれないことも出てきやすいものです。次の一歩を決める前に、心の整理が追いつかない感覚もあるかもしれません。",
(3,"mid"):   "年度末に向けて慌ただしくなるこの時期は、目の前のことに追われて、本音を後回しにしがちな頃でもあります。落ち着いて考える時間がないまま、決断だけを迫られることもあります。",
(3,"late"):  "年度末のこの時期は、次の一歩を決めなければという焦りと、まだ迷いが残る気持ちが同時にやってきやすいものです。周囲のペースに合わせるうちに、自分の本音が見えにくくなることもあります。",

(4,"early"): "新年度が始まったばかりのこの時期は、新しい環境やペースに慣れようとする一方で、本音を整理する余裕が後回しになりやすい頃です。頑張らなければという気持ちが先に立つこともあります。",
(4,"mid"):   "新年度のペースに少しずつ慣れてくるこの時期は、周りに合わせるうちに、自分の本音が見えにくくなることもあります。無理をしていることに、自分では気づきにくいものです。",
(4,"late"):  "ゴールデンウィークが近づくこの時期は、休みを前に気が緩む一方で、これまで先送りにしていたことが気になり始める頃です。休みが明けてからのことを、少し考えたくなる方もいるはずです。",

(5,"early"): "ゴールデンウィーク明けのこの時期は、休み中に考えたことと日常に戻ってからの現実との間で、気持ちの整理がつきにくくなりやすいものです。切り替えがうまくいかず、もやもやが残ることもあります。",
(5,"mid"):   "新緑の季節のこの時期は、過ごしやすさとは裏腹に、次の予定や決断を先延ばしにしたくなる頃でもあります。心地よさに流されて、大事なことを後回しにしてしまうこともあります。",
(5,"late"):  "5月も終わりに近づくこの時期は、上半期の折り返しを意識し始め、決めきれていないことが気になってくる頃です。時間だけが過ぎていく感覚に、焦りを覚える方もいるかもしれません。",

(6,"early"): "6月に入り、季節の変わり目を迎えるこの時期は、体調や気分の波を感じやすく、物事を決めるのを後回しにしがちな頃です。決断を急がず、少し様子を見たくなる方も多いはずです。",
(6,"mid"):   "梅雨のこの時期は、外の予定が立てづらい分、自分の内側にある迷いに気づきやすくなるものです。天気だけでなく、気持ちもすっきりしない日が続くことがあり、決断を先延ばしにしたくなることもあります。",
(6,"late"):  "6月も終わりに近づくこの時期は、上半期を振り返りたくなる一方で、まだ答えを出せていないことも残りやすい頃です。区切りを前に、決断を先延ばしにしたくなることもあります。",

(7,"early"): "7月に入り、今年も後半へ向かうこの時期は、上半期を振り返るタイミングだからこそ、先延ばしにしていたことが気になり始める頃です。忙しさにまぎれて、本音を確認できていない方も多いはずです。",
(7,"mid"):   "梅雨明けを待つこの時期は、予定が立てづらく、決断を先延ばしにしたくなる気持ちも出てきやすいものです。天気だけでなく、仕事や人間関係の先行きも読みづらく感じることがあります。",
(7,"late"):  "夏の予定が動き出すこの時期は、楽しみが増える一方で、まだ決めきれていない選択が気になり始める頃でもあります。予定を詰め込む前に、本音を確認しておきたくなる方もいるはずです。",

(8,"early"): "お盆前後のこの時期は、普段と違うペースになる分、立ち止まって自分のことを考える時間が増えやすいものです。日常から少し離れることで、見えてくる迷いもあります。",
(8,"mid"):   "夏の後半に入るこの時期は、疲れがたまりやすく、物事を決める判断が鈍りやすくなる頃でもあります。無理に結論を出そうとして、余計に迷ってしまうこともあります。",
(8,"late"):  "8月も終わりに近づくこの時期は、夏の疲れとともに、秋からのことを考え始めたくなる頃です。切り替えを急ぐあまり、本音を置き去りにしてしまうこともあるのではないでしょうか。",

(9,"early"): "9月に入り、季節の変わり目を迎えるこの時期は、気持ちを切り替えたい一方で、夏の間に先送りにしたことが気になり始める頃です。区切りをつけたいのに、決めきれないもどかしさもあります。",
(9,"mid"):   "秋分が近づくこの時期は、日が短くなる変化とともに、物事をじっくり考え直したくなる頃でもあります。急いで結論を出すより、少し時間をかけたくなる方もいるはずです。",
(9,"late"):  "9月も終わりに近づくこの時期は、下半期のことを意識し始め、決めきれていないことが気になってくる頃です。周囲の動きに合わせるうちに、自分の本音を見失いやすくなることもあります。",

(10,"early"): "10月に入り、実りの季節を迎えるこの時期は、これまでの成果を振り返りたくなる一方で、次の一歩を迷いやすい頃でもあります。頑張りを認めつつも、この先の決断は保留にしがちです。",
(10,"mid"):   "秋が深まるこの時期は、肌寒さが増すとともに、物事を丁寧に考え直したくなる頃です。慌ただしさが少し落ち着く分、心の中に残っていた迷いに気づきやすくなるものです。",
(10,"late"):  "10月も終わりに近づくこの時期は、年末を意識し始め、後回しにしていたことが気になってくる頃です。時間の流れが早く感じられ、焦りとともに迷いが顔を出すこともあります。",

(11,"early"): "11月に入り、秋も深まるこの時期は、一年の終わりが視野に入り始め、これまでの選択を振り返りたくなる頃です。このままでいいのか、あらためて考えたくなる方もいるはずです。",
(11,"mid"):   "肌寒さが増すこの時期は、外出の機会が減る分、自分の内側にある迷いに気づきやすくなるものです。一人の時間が増えることで、後回しにしていた本音が浮かんでくることもあります。",
(11,"late"):  "11月も終わりに近づくこの時期は、年末に向けて、決めきれていないことを整理したくなる頃です。慌ただしくなる前に、一度立ち止まりたくなる方も多いのではないでしょうか。",

(12,"early"): "12月に入り、一年の締めくくりを意識するこの時期は、今年やり残したことが気になり始める頃でもあります。忙しさの中で、本音を後回しにしてしまうこともあります。",
(12,"mid"):   "年末が近づくこの時期は、慌ただしさの中で、本音を後回しにしがちになる頃です。予定に追われるうちに、決断だけが先延ばしになっていくこともあるのではないでしょうか。",
(12,"late"):  "いよいよ年の瀬を迎えるこの時期は、一年を振り返りながら、来年への迷いや期待が入り混じりやすい頃です。区切りを前に、素直な気持ちを確認したくなる方もいるはずです。",
}

def generate_caption_intro(monday_key):
    """その週(monday_key)の月・時期に応じた、自己分析フレーミングの冒頭文を返す"""
    y, m, d = map(int, monday_key.split("-"))
    t = "early" if d <= 10 else ("mid" if d <= 20 else "late")
    return CAPTION_INTRO_TABLE[(m, t)]

def build_caption_hook(keyword):
    """冒頭文の締め：カード固有のキーワードでタロットへつなげる一文"""
    return f"今週のタロットは、「{keyword}」というテーマから、その理由を一緒に見ていくための一枚でした。"
...
def build_caption(data):
    ...
    intro     = generate_caption_intro(data["key"])              # 季節・時期に応じた冒頭文（自己分析フレーミング）
    intro_hook = build_caption_hook(data["keywords"][0] if data["keywords"] else data["lucky"]["keyword"])
